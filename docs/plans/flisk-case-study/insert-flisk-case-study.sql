-- Recreate the deleted Flisk case study.
-- The 20 existing Flisk screen rows are intentionally left unchanged.
...
BEGIN
  IF EXISTS (
    ...
    RAISE EXCEPTION 'A Flisk case study already exists';
  END IF;
END
$check$;
