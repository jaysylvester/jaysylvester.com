...
gulp.task('css', function (done) {
  gulp.src(['web/source/scss/reset.css', 'web/source/scss/global.scss', 'web/source/scss/**/**.scss'])
...
gulp.task('watch', function(done) {
  livereload.listen()
  gulp.watch(['web/source/scss/**/**.scss', 'web/source/scss/**/**.css'], gulp.parallel('css'))
